...
echo -e "\n------------------ start noVNC  ----------------------------"
if [[ $DEBUG == true ]]; then echo "$NO_VNC_HOME/utils/launch.sh --vnc localhost:$VNC_PORT --listen $PORT"; fi
$NO_VNC_HOME/utils/launch.sh --vnc localhost:$VNC_PORT --listen $PORT &> $STARTUPDIR/no_vnc_startup.log &
PID_SUB=$!
...
echo -e "\nnoVNC HTML client started:\n\t=> connect via http://$VNC_IP:$PORT/?password=...\n"
